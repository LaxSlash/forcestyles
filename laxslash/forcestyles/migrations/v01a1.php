...
class v01a1 extends migration
{
	...
	{
		return array(
			array('permission.add', array('a_laxslash_forcestyles_force_styles')),
			...
			array('config.add', array('laxslash_forcestyles_version', '0.1 ALPHA 1')),
	...
	public function revert_data()
	{
		return array(
			...
			array('config.remove', array('laxslash_forcestyles_version')),
